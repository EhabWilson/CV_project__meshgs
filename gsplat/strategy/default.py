...
class DefaultStrategy(Strategy):
    ...
    def step_post_backward(
        ...
        means = "bg_means" if is_bg else "means" 
        if (
            ...
            # grow GSs
            n_dupli, n_split = self._grow_gs(params, optimizers, state, step, is_bg)
            if self.verbose:
                print(
            ...
            # prune GSs
            n_prune = self._prune_gs(params, optimizers, state, step, is_bg)
            if self.verbose:
                print(
    ...
    def _grow_gs(
        ...
        scales = "bg_scales" if is_bg else "scales"
    ...
    def _prune_gs(
        ...
        opacities = "bg_opacities" if is_bg else "opacities"
        scales = "bg_scales" if is_bg else "scales"
